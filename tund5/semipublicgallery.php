<?php
	...
	$limit = 15;//mitu pilti ühele lehele soovin mahutada. Reaalelus oleks normaalne palju suurem number, näiteks 30 jne
	$picCount = countPics($privacy);//küsin kõigi näidatavate piltide arvu, et teada, palju lehekülgi üldse olla võiks. Parameetriks piltide privaatsus. Funktsioon ise näitena allpool.
	//echo $picCount;
	...
	$privateThumbnails = readAllSemiPublicPictureThumbsPage($privacy, $page, $limit);
?>
<!DOCTYPE html>
<html lang="et">
<head>
